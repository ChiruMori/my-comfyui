...
克隆效果很好，比如这个音频是使用铃兰（来自明日方舟）的音色，念文明6的开场词

<audio src="doc/civilization.mp3" controls></audio>
...
效果如下（使用上面的音频，加上一个绿幕铃兰图像生成）：

<video src="doc/civilization.mp4" height="300px" controls>